...
class SiswaaController extends Controller
{
    ...
    public function store(Request $request)
    {
    	...
    	$status = \App\Siswaa::create($input);
    ...
    {
    	$data['result'] = \App\Siswaa::where('nis', $id)->first();
    ...
    public function update(Request $request, $id)
    {
    	...
    	$input = $request->all();
    	$result = \App\Siswaa::where('nis', $id)->first();
    ...
    public function destroy(Request $request, $id)
    {
    	...
    	if ($status) return redirect('siswa')->with('success','Data Berhasil Didelete');
		else return redirect('siswa')->with('error','Data Gagal Diubah');
    }
}
